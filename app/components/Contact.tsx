    ...
    <section id="contact" className="container mx-auto px-5 py-4">
      ...
      <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        ...
        <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
          <h2 className="text-gray-900 text-lg mb-1 font-medium title-font font-semibold underline">
            ที่อยู่
          </h2>
          ...
          <h2 className="text-gray-900 text-lg mb-0 font-medium title-font font-semibold underline">
            Contact
          </h2>
          ...
          <div className="relative mb-1">
            <h2 className="text-gray-900 text-lg mb-0 font-medium title-font font-semibold underline">Email</h2>
            ...
            <h1 className="text-gray-900 text-lg mb-0 font-medium title-font font-semibold underline">Tel.</h1>
            <p className="">02-950-0525<br></br>089-113-8565</p>
            <h1 className="text-gray-900 text-lg mb-0 font-medium title-font font-semibold underline">Fax.</h1>
            <p className="">02-950-0470</p>
            <h1 className="text-gray-900 text-lg mb-0 font-medium title-font font-semibold">LineID:@Mtax</h1>
          </div>
        </div>
      </div>
    </section>
