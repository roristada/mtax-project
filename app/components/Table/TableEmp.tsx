...
export default function TableData({ onSelectEmployee }: { onSelectEmployee: (employeeId: number) => void }) {
  ...
  return (
    ...
    <DataGrid
            ...
            loading={loading}
            onRowClick={(params) => params.row.employee_id && onSelectEmployee(params.row.employee_id)}
          />
    </div>
